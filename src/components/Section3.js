      ...
      <ul className="list-group m-5">
        ...
        <li className="list-group-item bg hv">
          ...
          <p className="text-start">
            ...
            when students take pride in their project and learning, and so does
            the school. We have embedded this element in the program.
          </p>
        </li>
        <br />
        <li className="list-group-item bg hv">
          ...
          <p className="text-start">
            ...
            there is a spirit of collaboration to help the student take his/her
            green journey
          </p>
        </li>
        <br />
